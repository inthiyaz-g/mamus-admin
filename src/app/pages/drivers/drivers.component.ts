...
export class DriversComponent implements OnInit {
  ...
  editChanges() {
    ...
    if (this.fname == '' || this.fname == null || this.lname == '' || this.lname == null ||
      this.address == null || this.address == '' || this.lat == null || this.lat == '' || this.lng == '' ||
      this.lng == null || this.city == '' || this.city == null) {
  ...
  saveChanges() {
    ...
    if (this.fname == '' || this.fname == null || this.lname == '' || this.lname == null || this.email == '' || this.email == null ||
      ...
      this.address == null || this.address == '' || this.lat == null || this.lat == '' || this.lng == '' || this.lng == null || this.city == '' || this.city == null) {
      this.util.error('All fields are required');
      return false;
    }
