...
@Component({
  selector: "app-administrantor",
  templateUrl: "./administrantor.component.html",
  styleUrls: ["./administrantor.component.scss"],
})
export class AdministrantorComponent implements OnInit {
  ...
  statusUpdate(item: any) {
    ...
    Swal.fire({
      ...
      text:
        this.util.translate("To") +
        " " +
        this.util.translate(text) +
        " " +
        this.util.translate("this user!"),
      icon: "question",
      ...
      if (data && data.value) {
        ...
        this.util.show();
        this.api
          .post_private("v1/profile/update", item)
          .then(
            (datas) => {
              this.util.hide();
  ...
  deleteItem(item: any) {
    ...
    Swal.fire({
      ...
      if (data && data.value) {
        ...
        this.util.show();
        this.api
          .post_private("v1/users/deleteUser", item)
          .then(
            (datas) => {
              this.util.hide();
  ...
  exportCSV() {
    ...
    this.util.downloadFile(data, name, [
      "id",
      "first_name",
      "last_name",
      "cover",
  ...
  saveChanges() {
    ...
    this.util.show();
    this.api
      .post_private("v1/users/adminNewAdmin", param)
      .then(
        (data: any) => {
          this.util.hide();
          console.log(data);
          ...
          if (
            ...
            this.util.success(
              this.util.translate("Account created successfully")
            );
            console.log(data);
            this.myModal2.hide();
            this.getAllUsers();
